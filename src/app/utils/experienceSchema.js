...
export default Yup.object({
    ...
    date_start : Yup.date().required('obligatoire').max(new Date(), "doit être superieure a la date d'aujourd'hui").min(new Date('1980-01-01'),"doit être superieur au 1er janvier 1980"),
