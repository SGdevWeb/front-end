...
export default Yup.object({
    ...
    date_start : Yup.date().required('obligatoire').max(new Date(), "doit être superieure a la date d'aujourd'hui").min(new Date('2000-01-01'),"doit être supereire au 1er janvier 2000"),
